...
#ifdef _DEBUG
	memcpy(szConfigFile, "q:\\post\\config_robot.xml", strlen("q:\\post\\config_robot.xml"));
#else
...
void CInitPath::GetPathFromCfg(void)
{
	...
	// папка исходящей почты для всех ОДПИ
	...
	//Цикл получения направлений отправки на ОДПИ и папки для Fossmail
