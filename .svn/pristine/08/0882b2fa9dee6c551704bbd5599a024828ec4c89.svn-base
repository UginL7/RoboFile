...
void CPostParser::Run()
{
	...
	// Проверка входящей/исходящей почты 
	//Отправка почты на Киев
	pKiev = new CKievPost();
	...
	m_ListFile.clear();
	//Отправка почты на конкретные районы
	...
	//Отправка почты на все районы + СДПИ
